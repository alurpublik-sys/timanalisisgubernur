...
type Profile = { active:boolean; created_at:string; email:string|null; full_name:string|null; role:string; updated_at:string; user_id:string }
...
type Tim = { active:boolean; created_at:string; id:number; kode:string|null; legacy_id:string|null; link_cv:string|null; link_foto:string|null; nama:string; peran:string|null; updated_at:string; user_id:string|null }

export type Database = {
  __InternalSupabase: { PostgrestVersion: '14.5' }
  public: {
    Tables: {
      absensi_agenda: Table<Absensi,
        { agenda_event_id:string; bobot_agenda?:number; created_at?:string; detail_agenda:string; id?:number; jenis_agenda:string; kode?:string|null; lokasi?:string|null; nama_anggota:string; status_kehadiran:string; tanggal:string; tim_id?:number|null; updated_at?:string }, Partial<Absensi>>
      ...
      profiles: Table<Profile, { active?:boolean; created_at?:string; email?:string|null; full_name?:string|null; role?:string; updated_at?:string; user_id:string }, Partial<Profile>>
      ...
      tim_analisis: Table<Tim, { active?:boolean; created_at?:string; id?:number; kode?:string|null; legacy_id?:string|null; link_cv?:string|null; link_foto?:string|null; nama:string; peran?:string|null; updated_at?:string; user_id?:string|null }, Partial<Tim>>
    }
    Views: {
      dashboard_stats: { Row: { total_agenda:number|null; total_isu:number|null; total_kunjungan:number|null; total_media:number|null; total_policy_brief:number|null }; Relationships: [] }
    }
